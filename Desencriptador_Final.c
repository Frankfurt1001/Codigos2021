...
int main(int argc, char *argv[]) {
	...
	do{//hacer mientras que......
		...
		u=(n-7+10)%10;//le resto 7
		dec=((n/10)-7+10)%10;//me muevo al 2do digito, le rsto 7 y y le saco modulo
		cen=((n/100)-7+10)%10;//me muevo al 3er digito, le resto 7 y le saco modulo
		...
		printf("\n Su numero encriptado es:%d%d%d%d\t", dec, u, um, cen);
		printf("\n\nDesea ingresar otro numero?\n");
		printf("\nPulse 1 si desea salir del programa, si quiere continuar ingrese cualquier otro numero\t");
		scanf("%d", &d);
		if(d==1)
			i=1;
		else
